                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${event.artist}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${event.city}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${event.country}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${event.startDate}</td>
